...
def get_parser(parser=None):
    ...
    train_arg.add_argument('--model_load', default=None)
    train_arg.add_argument('--target', default=None)
    train_arg.add_argument('--n_ins', default=10, type=int)
    ...
    train_arg.add_argument('--train_epochs', type=int, default=101,
    ...
    train_arg.add_argument('--latent_vector_dim', type=int, default=128,
